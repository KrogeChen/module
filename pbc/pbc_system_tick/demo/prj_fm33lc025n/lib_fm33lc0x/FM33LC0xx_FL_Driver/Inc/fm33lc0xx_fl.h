...
/**
  * @brief FM33LC0xx FL Driver Library version number v2.0.0
  */
#define __FM33LC0xx_FL_VERSION_MAIN   (0x02) /*!< [31:24] main version */
#define __FM33LC0xx_FL_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __FM33LC0xx_FL_VERSION_SUB2   (0x00) /*!< [15:0]  sub2 version */
#define __FM33LC0xx_FL_VERSION_RC     (0x00) /*!< [7:0]   release candidate(RFU) */
#define __FM33LC0xx_FL_VERSION        ((__FM33LC0xx_FL_VERSION_MAIN  << 24)\
                                         |(__FM33LC0xx_FL_VERSION_SUB1 << 16)\
                                         |(__FM33LC0xx_FL_VERSION_SUB2 << 8 )\
                                         |(__FM33LC0xx_FL_VERSION_RC))

/**
  * @brief Macros used by delay support functions
  */
#define FL_DELAY_US                (__SYSTEM_CLOCK/1000000)
#define FL_DELAY_MS                (__SYSTEM_CLOCK/1000)
